...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.print("Registre la distancia total del viaje (en kilómetros): ");
        distancia = leerTeclado.nextDouble();

        // Se le solicita al usuario el consumo de su automovil (litros por cada 100 km)
        System.out.print("Registre el consumo de combustible del automóvil (litros por cada 100 km): ");
        consumo100km = leerTeclado.nextDouble();

        // Se le solicita al usuario el precio por litros del combustible
        System.out.print("Registre el precio por litro de combustible: ");
